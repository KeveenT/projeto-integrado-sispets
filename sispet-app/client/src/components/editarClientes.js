...
const EditarCliente = ({ cliente }) => {
    ...
    const updateCliente = (id) => {
        ...
        axios.put(`https://projeto-integrado-sispets-prod.up.railway.app/api/cliente/update/${id}`, JSON.stringify({nome: nomeCliente, cpf: cpfCliente, cep: cepCliente, endereço: endereçoCliente, telefone: telefoneCliente, email: emailCliente, id: clienteId}), {
            headers: {
